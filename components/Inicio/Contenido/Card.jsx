      ...
      >
        ...
        >
          <section className="flex flex-col px-1 gap-0 pb-2 lg:pb-[20px]">
            ...
            <div className="flex justify-between gap-1 mt-1 rounded-[5px] w-full px-1 sm:px-4 py-1 bg-white dark:bg-dark-d">
              {(tarifaPresencial[0]?.value || tarifaVirtual[0]?.value) && <h2 className="text-black my-auto text-[12px]  px-2 sm:px-6 py-1 bg-back-blue rounded-[10px] shadow-md">
                ...
                <h2 className="text-black my-auto text-[12px] px-1 sm:px-4 py-1 bg-back-blue rounded-[10px] shadow-md">
                  {nacionalidad}
                </h2>
