...
const CrearAnuncio = () => {
  ...
  const diasOptions = ["LU", "MA", "MI", "JU", "VI", "SA", "DO"];
          ...
          <div className="z-100 fixed flex bg-dark-l h-full w-screen overflow-x-hidden items-center justify-center text-white">
            <section className="relative bg-[#144912] border-4 border-[#63ff41] p-10 flex flex-col items-center justify-center gap-1 mx-4">
              <Link
                ...
                className="absolute text-red-500 font-bold top-0 right-0 text-xl p-1 bg-black hover:scale-105"
              >
                <RiCloseFill />
              </Link>
              ...
              <inactive className="flex flex-col items-center justify-center gap-1">
                <nav className="text-center font-extralight text-sm">
                  Pero tu anuncio se encuentra inactivo
                </nav>
                <img
                  width="18"
                  height="18"
              ...
              <buttons className="flex gap-2 mt-4">
                ...
                <Link
                  ...
                  className="p-4 bg-violet-600 hover:bg-violet-700 rounded text-center font-extrabold"
                >
                  Activar anuncio
                </Link>
              </buttons>
          ...
          >
            <containerform className=" grid sm:grid-cols-2 lg:grid-cols-2 gap-10 my-10">
              <div className="flex flex-col gap-1 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.name && error && error?.name ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.name}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.whatsapp && error && error?.whatsapp ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.whatsapp}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-1 w-[300px] sm:w-full mx-auto">
                <div className="flex flex-col gap-1 w-full">
                  <label
                    htmlFor="name"
                    className="dark:text-whitet text-blackt"
                  >
                    Tarifa presencial (S/):
                  </label>
                  ...
                  <div className="grid grid-cols-1 gap-1 w-full text-sm">
                    <div className="flex gap-10 w-[100%]">
                      <label
                        htmlFor="name"
                        className="dark:text-whitet text-blackt w-full my-auto"
                      >
                        60 minutos:
                      </label>
                      ...
                      <div className="flex flex-col gap-2 w-full overflow-hidden">
                        <input
                          ...
                          name="60"
                          value={
                            formContent?.tarifaPresencial &&
                            formContent?.tarifaPresencial[0]?.value
                          }
                    ...
                    <div className="flex gap-10 w-[100%]">
                      ...
                      <div className="flex flex-col gap-2 w-full overflow-hidden">
                        <input
                          ...
                          value={
                            formContent?.tarifaPresencial &&
                            formContent?.tarifaPresencial[1]?.value
                          }
                          onChange={handleTarifaPresencial}
                          placeholder=""
                          className="focus:ring focus:ring-yellow-400 focus:bg-yellow-50 dark:focus:bg-slate-800 focus:transition-all focus:ease-in-out transition-all ease-in-out duration-300 focus:duration-300 p-[10px] border-2 dark:text-whitet text-blackt bg-whitet dark:bg-dark-d  dark:focus:text-blackt rounded-[10px] outline-none"
                    ...
                    <div className="flex gap-10 w-[100%]">
                      ...
                      <div className="flex flex-col gap-2 w-full overflow-hidden">
                        <input
                          ...
                          name="60"
                          value={
                            formContent?.tarifaVirtual &&
                            formContent?.tarifaVirtual[0]?.value
                          }
                    ...
                    <div className="flex gap-10 w-[100%]">
                      ...
                      <div className="flex flex-col gap-2 w-full overflow-hidden">
                        <input
                          ...
                          value={
                            formContent?.tarifaVirtual &&
                            formContent?.tarifaVirtual[1]?.value
                          }
                          onChange={handleTarifaVirtual}
                          placeholder=""
                          className="focus:ring focus:ring-yellow-400 focus:bg-yellow-50 dark:focus:bg-slate-800 focus:transition-all focus:ease-in-out transition-all ease-in-out duration-300 focus:duration-300 p-[10px] border-2 dark:text-whitet text-blackt bg-whitet dark:bg-dark-d  dark:focus:text-blackt rounded-[10px] outline-none"
                    ...
                    <div className="flex gap-10 w-[100%]">
                      ...
                      <div className="flex flex-col gap-2 w-full overflow-hidden">
                        <input
                          ...
                          value={
                            formContent?.tarifaVirtual &&
                            formContent?.tarifaVirtual[2]?.value
                          }
                          onChange={handleTarifaVirtual}
                          placeholder=""
              ...
              <atencion className="flex flex-col gap-[12px] w-[300px] sm:w-full mx-auto">
                <containerhorarioatencion className="bg-[#fff176] dark:bg-[#2c2c2c] p-4 rounded-[10px] grid gap-2">
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      Selecciona tus categorias de atención:
                    </label>
                    <label
                      htmlFor="name"
                    ...
                    {changeViewError && error && error?.categorias ? (
                      <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                        {error?.categorias}
                      </p>
                    ) : touchedFields.categorias &&
                      error &&
                      error?.categorias ? (
                      <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                        {error?.categorias}
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.description && error && error?.description ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.description}
                  </p>
                ) : (
                  ...
                  <containerhorarioatencion className="bg-[#fff176] dark:bg-[#2c2c2c] p-4 rounded-[10px] grid gap-2">
                    <div className="flex flex-col gap-2">
                      <label
                        ...
                        className="dark:text-whitet text-blackt"
                      >
                        Selecciona tus días de atención:
                      </label>
                      ...
                      {changeViewError && error && error?.diasAtencion ? (
                        <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                          {error?.diasAtencion}
                        </p>
                      ) : touchedFields.diasAtencion &&
                        error &&
                        error?.diasAtencion ? (
                        <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                          {error?.diasAtencion}
                      ...
                      <div className="flex flex-row sm:flex-col gap-2">
                        ...
                        <hora className="flex flex-row gap-[1px]">
                          ...
                          >
                            ...
                            <option name="1:00" value="2:00">
                              2:00
                            </option>
                            <option name="1:00" value="3:00">
                              3:00
                            </option>
                            <option name="1:00" value="4:00">
                              4:00
                            </option>
                            <option name="1:00" value="5:00">
                              5:00
                            </option>
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                {changeViewError && error && error?.nacionalidad ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.nacionalidad}
                  </p>
                ) : touchedFields.nacionalidad &&
                  error &&
                  error?.nacionalidad ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.nacionalidad}
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                {changeViewError && error && error?.region ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.region}
                  </p>
                ) : touchedFields.region && error && error?.region ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.region}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                {changeViewError && error && error?.lugar ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.lugar}
                  </p>
                ) : touchedFields.lugar && error && error?.lugar ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.lugar}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.edad && error && error?.edad ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.edad}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                {changeViewError && error && error?.idioma ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.idioma}
                  </p>
                ) : touchedFields.idioma && error && error?.idioma ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.idioma}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.peso && error && error?.peso ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.peso}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                ) : touchedFields.altura && error && error?.altura ? (
                  <p className="text-white text-center font-mono text-[12px] p-1 bg-red-500 w-auto ">
                    {error?.altura}
                  </p>
                ) : (
              ...
              <div className="flex flex-col gap-2 w-[300px] sm:w-full mx-auto">
                ...
                <div className="flex flex-wrap gap-2">
                  {formContent &&
                    formContent?.galeriaVideos &&
                    formContent?.galeriaVideos?.map((g, index) => (
                      <div key={index} className="relative">
                        <video
                          key={index}
                          src={g}
                        ...
                        <button
                          ...
                          onClick={() => {
                            setFormContent((prevFormContent) => ({
                              ...prevFormContent,
                              galeriaVideos:
                                prevFormContent.galeriaVideos.filter(
                                  (video) => video !== g
                                ),
                            }));
                          }}
            ...
            <preguntaobligatoria className="mb-5 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <div className="flex flex-col gap-2 items-center justify-center dark:text-whitet text-blackt">
                <h1 className="text-normal sm:text-xl font-bold">
                  ¿Cómo te enteraste de nosotros?
                </h1>
                <h6 className="text-[12px] sm:text-sm">
                  (Pregunta obligatoria para continuar)
                </h6>
              </div>
              <textarea
                type="text"
            ...
            <terminoscondiciones className="w-[300px] sm:w-full mx-auto flex flex-col items-center gap-2 mb-5 font-bold dark:text-whitet text-blackt">
              ...
              <Link
                target="_blank"
                href={
                  "https://drive.google.com/file/d/1H1T-qnLR4bL4JWBkqTff3pnf8qfCqUA_/view?usp=drive_link"
                }
                className={`text-sm text-red-500 hover:text-red-700 transition-all duration-300 ease-in-out`}
              >
